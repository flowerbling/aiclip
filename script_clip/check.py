...
# 正确时间格式的正则表达式
time_pattern = re.compile(r"^\d\d:\d\d:\d\d,\d{1,3} --> \d\d:\d\d:\d\d,\d{1,3}$")
...
if __name__ == "__main__":
    path = (
        "/Users/anning/PycharmProjects/untitled/ScriptClip/测试文件/合并视频/merged_1.mp4"
    )
    data = """
    [
                {
